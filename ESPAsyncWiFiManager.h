...
const char HTTP_SERVER_FORM[] PROGMEM     = "<form method='get' action='serversave'><input id='serveraddr' name='serveraddr' placeholder='Remote server address' value='{v}'><br/><br/><button type='submit'>Save</button><br/><br/>{s}</form>";
...
private:
  ...
  void          handleServer(AsyncWebServerRequest *);
  void          handleServerSave(AsyncWebServerRequest *);
